...
<html lang="en">
   <head>
      ...
      <title>Blog Categories - Responsive Website Template | Block</title>
   </head>
                  ...
                  <div class="col-lg-12">
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb fw-medium">
                           ...
                           <li class="breadcrumb-item active text-primary" aria-current="page">Design</li>
                        </ol>
                     </nav>
                  </div>
                  <div class="col-lg-7 col-md-12 col-12">
                     <h1 class="mb-3">Design</h1>
                     <p class="mb-0 lead">Lorem ipsum dolor sit amet, consectetur amet congue libero. In finibus risus a finibus maximus.‍</p>
                  </div>
               </div>
            </div>
         </section>
            ...
            <div class="container">
               <div class="row gy-lg-7 gy-5">
                  <article class="col-lg-4 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <a href="./blog-single.html">
                           <img src="./assets/images/blog/blog-img-9.jpg" alt="blog" class="img-fluid rounded-3" loading="lazy" />
                        </a>
                     </figure>
                  ...
                  <article class="col-lg-4 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <a href="./blog-single.html">
                           <img src="./assets/images/blog/blog-img-1.jpg" alt="blog" class="img-fluid rounded-3" loading="lazy" />
                        </a>
                     </figure>
                  ...
                  <article class="col-lg-4 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <a href="./blog-single.html">
                           <img src="./assets/images/blog/blog-img-2.jpg" alt="blog" class="img-fluid rounded-3" loading="lazy" />
                        </a>
                     </figure>
                  ...
                  <article class="col-lg-4 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <a href="./blog-single.html">
                           <img src="./assets/images/blog/blog-img-3.jpg" alt="blog" class="img-fluid rounded-3" loading="lazy" />
                        </a>
                     </figure>
                  ...
                  <article class="col-lg-4 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <a href="./blog-single.html">
                           <img src="./assets/images/blog/blog-img-5.jpg" alt="blog" class="img-fluid rounded-3" loading="lazy" />
                        </a>
                     </figure>
                  ...
                  <article class="col-lg-4 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <a href="./blog-single.html">
                           <img src="./assets/images/blog/blog-img-4.jpg" alt="blog" class="img-fluid rounded-3" loading="lazy" />
                        </a>
                     </figure>
