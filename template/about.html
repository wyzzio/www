               ...
               <div class="row">
                  <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                     <div class="text-center">
                        ...
                        <h1 class="mb-3 mt-3">Empowering the world to design</h1>
                        <p class="mb-0 px-lg-6">
                           We are Block, a Digital Product Design & Branding Agency. As a team of Designers, Business Analysts, Strategists, Content Writers, and Project Managers, we collaborate on a
                           result-oriented design process.
                        </p>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-12">
                     <a href="./assets/images/about-img/about-img-1.jpg" class="glightbox rounded-3">
                        <div
                           ...
                           style="background-image: url(./assets/images/about-img/about-img-1.jpg); background-repeat: no-repeat; height: 350px; background-size: cover"></div>
                     </a>
                  </div>
                  <div class="col-lg-4 col-md-4 col-12">
                     <a href="./assets/images/about-img/about-img-2.jpg" class="glightbox rounded-3">
                        <div
                           class="rounded-3 card-lift"
                           style="background-image: url(./assets/images/about-img/about-img-2.jpg); background-repeat: no-repeat; height: 350px; background-size: cover"></div>
                     </a>
                  </div>
                  <div class="col-lg-4 col-md-4 col-12">
                     <a href="./assets/images/about-img/about-img-3.jpg" class="glightbox rounded-3">
                        <div
                           class="rounded-3 card-lift"
                           style="background-image: url(./assets/images/about-img/about-img-3.jpg); background-repeat: no-repeat; height: 350px; background-size: cover"></div>
                     </a>
                  </div>
               </div>
            </div>
               ...
               <div class="row border-top border-bottom">
                  <div class="col-lg-4 col-md-4 col-12 border-end-md border-bottom border-bottom-md-0">
                     <div class="text-center p-5">
                        <img src="./assets/images/award-logo/award-logo-1.svg" alt="award" class />
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-4 col-12 border-end-md border-bottom border-bottom-md-0">
                     <div class="text-center p-5">
                        <img src="./assets/images/award-logo/award-logo-2.svg" alt="award" class />
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-4 col-12">
                     <div class="text-center p-5">
                        <img src="./assets/images/award-logo/award-logo-3.svg" alt="award" class />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="container">
               ...
               <div class="row d-flex align-items-center mb-md-9 mb-6">
                  <div class="col-lg-6 col-md-6 col-12">
                     <figure class="mb-4 mb-md-0">
                        <img src="./assets/images/about-img/about-value-img-1.jpg" alt="value" class="img-fluid rounded-3" />
                     </figure>
                  </div>
                  <div class="col-lg-5 offset-lg-1 col-md-6 col-12">
                     <span class="text-primary fw-semibold">01</span>
                     <div class="mb-4">
                        <h3 class="mt-4 mb-3">Create Brands</h3>
                        <p class="mb-0">
                           We create brands, interactions, communications, and a wide variety of design daily. It is not only a work routine but also our way of fulfilling seemingly impossible tasks.
                        </p>
                     </div>
               ...
               <div class="row d-flex align-items-center mb-md-9 mb-6">
                  ...
                  <div class="col-lg-6 offset-lg-1 col-md-6 col-12 order-md-2">
                     <figure class="mb-4">
                        <img src="./assets/images/about-img/about-value-img-2.jpg" alt="value" class="img-fluid rounded-3" />
                     </figure>
                  </div>
               </div>
               ...
               <div class="row d-flex align-items-center mb-md-9 mb-6">
                  <div class="col-lg-6 col-md-6 col-12">
                     <figure class="mb-4 mb-md-0">
                        <img src="./assets/images/about-img/about-value-img-3.jpg" alt="value" class="img-fluid rounded-3" />
                     </figure>
                  </div>
                  <div class="col-lg-5 offset-lg-1 col-md-6 col-12">
               ...
               <div class="row gy-5">
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src="./assets/images/team/team-img-4.jpg" alt="team" class="rounded-3 img-fluid" />
                     </figure>
                     <div class="mb-4">
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src="./assets/images/team/team-img-2.jpg" alt="team" class="rounded-3 img-fluid" />
                     </figure>
                     <div class="mb-4">
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src="./assets/images/team/team-img-3.jpg" alt="team" class="rounded-3 img-fluid" />
                     </figure>
                     <div class="mb-4">
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src="./assets/images/team/team-img-1.jpg" alt="team" class="rounded-3 img-fluid" />
                     </figure>
                     <div class="mb-4">
