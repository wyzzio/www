...
<html lang="en">
   <head>
      ...
      <title>Blog List View Responsive Website Template | Block</title>
   </head>
               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <article class="row d-flex align-items-center mb-7 mb-md-5">
                        ...
                        <div class="col-lg-7 col-xl-7 col-md-12 col-12">
                           <div class="ms-lg-4">
                              <a href="#!" class="mb-3 badge bg-warning-subtle text-warning-emphasis rounded-pill text-uppercase">business</a>
                              <div class="mb-4">
                                 <h3 class="lh-base h4">
                     ...
                     <article class="row d-flex align-items-center mb-7 mb-md-5">
                        ...
                        <div class="col-lg-7 col-xl-7 col-md-12 col-12">
                           <div class="ms-lg-4">
                              <a href="#!" class="mb-3 badge bg-info-subtle text-info-emphasis rounded-pill text-uppercase">startup</a>
                              <div class="mb-4">
                                 <h3 class="lh-base h4">
                              ...
                              <div class="d-md-flex align-items-center justify-content-between">
                                 <div class="d-flex align-items-center mb-3 mb-md-0">
                                    ...
                                    <div class="ms-3"><span class="fs-6">Nov 11, 2023</span></div>
                                 </div>
                                 <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                       <a href="#!" class="text-reset">
