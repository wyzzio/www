...
<html lang="en">
   <head>
      ...
      <title>Account Social Links - Responsive Website Template | Block</title>
   </head>
                        ...
                        <div class="card-body p-lg-5">
                           <div class="row mb-4">
                              ...
                              <div class="col-lg-9 col-md-8">
                                 ...
                                 <input type="text" class="form-control mb-1" placeholder="Twitter" id="twitterInput" />
                           ...
                           <div class="row mb-4">
                              ...
                              <div class="col-lg-9 col-md-8">
                                 ...
                                 <input type="text" class="form-control mb-1" placeholder="Github" id="githubInput" />
                           ...
                           <div class="row mb-4">
                              ...
                              <div class="col-lg-9 col-md-8">
                                 ...
                                 <input type="text" class="form-control mb-1" placeholder="YouTube Handle" id="YouTubeInput" />
                           ...
                           <div class="row mb-4">
                              ...
                              <div class="col-lg-9 col-md-8">
                                 ...
                                 <input type="text" class="form-control mb-1" placeholder="Profile Link" id="linkedIn" />
                           ...
                           <div class="row mb-4">
                              ...
                              <div class="col-lg-9 col-md-8">
                                 ...
                                 <input type="text" class="form-control mb-1" placeholder="Instagram name" id="instagram" />
