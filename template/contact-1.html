...
<html lang="en">
   <head>
      ...
      <title>Contact us v1 - Responsive Website Template | Block</title>
   </head>
               ...
               <div class="row g-4">
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     ...
                     <figure class="mb-3 card-lift">
                        <img src="./assets/images/location/location-1.jpg" alt="location" class="img-fluid rounded-3" />
                     </figure>
                     <div class="d-flex">
                        <div>
                           <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill text-primary" viewBox="0 0 16 16">
                              <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                           </svg>
                        </div>
                        <div class="ms-2">
                           <span>WeWork, 412, Residency Rd, Shanthala Nagar, Ashok Nagar, Bengaluru, Karnataka 560025</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-12">
                     ...
                     <figure class="mb-3 card-lift">
                        <img src="./assets/images/location/location-2.jpg" alt="location" class="img-fluid rounded-3" />
                     </figure>
                     <div class="d-flex">
                        <div>
                           <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill text-primary" viewBox="0 0 16 16">
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     ...
                     <figure class="mb-3 card-lift">
                        <img src="./assets/images/location/location-3.jpg" alt="location" class="img-fluid rounded-3" />
                     </figure>
                     <div class="d-flex">
                        <div>
                           <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill text-primary" viewBox="0 0 16 16">
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     ...
                     <figure class="mb-3 card-lift">
                        <img src="./assets/images/location/location-4.jpg" alt="location" class="img-fluid rounded-3" />
                     </figure>
                     <div class="d-flex">
                        <div>
                           <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill text-primary" viewBox="0 0 16 16">
