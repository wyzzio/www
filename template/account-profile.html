...
<html lang="en">
   <head>
      ...
      <title>Account Profile - Responsive Website Template | Block</title>
   </head>
   <body>
      <!-- Navbar -->
      <header>
      ...
      <script src="./assets/libs/cleave.js/dist/cleave.min.js"></script>
      <script src="./assets/libs/cleave.js/dist/addons/cleave-phone.i18n.js"></script>
